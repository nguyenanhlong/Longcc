		...
		<div class="col-md-3">
			...
			<div class="card card-category">
			  <div class="img-wrap" style={{background:"#ffd7d7"}}>
			  	<img src={require("../../assets/images/items/1.jpg")}></img>
			  </div>
			  <div class="card-body">
		...
		<div class="col-md-3">
			<div class="card card-category">
			  <div class="img-wrap" style={{background:"#FFF68D"}}>
			  	<img src={require("../../assets/images/items/2.jpg")}></img>
			  </div>
			  <div class="card-body">
		...
		<div class="col-md-3">
			<div class="card card-category">
			  <div class="img-wrap" style={{background:"#bcffb8"}}>
			  	<img src={require("../../assets/images/items/3.jpg")}></img>
			  </div>
			  <div class="card-body">
		...
		<div class="col-md-3">
			<div class="card card-category">
			  <div class="img-wrap" style={{background:"#c9fff3"}}>
			  	<img src={require("../../assets/images/items/4.jpg")}></img>
			  </div>
			  <div class="card-body">
		...
		<div class="col-md-3">
			<div class="card card-category">
			  <a href="#" class="img-wrap" style={{background:"#ddffeb"}}>
			  	<img src={require("../../assets/images/items/5.jpg")}></img>
			  </a>
			  <div class="card-body">
		...
		<div class="col-md-3">
			<div class="card card-category">
			  <a href="#" class="img-wrap" style={{background:"#dee4ff"}}>
			  	<img src={require("../../assets/images/items/6.jpg")}></img>
			  </a>
			  <div class="card-body">
